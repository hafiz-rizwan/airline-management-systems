...
namespace Airline.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public TicketsController(NeondbContext context)
        {
            _context = context;
        }
        ...
        {
            var neondbContext = _context.Tickets.Include(t => t.Flight).Include(t => t.Passenger);
        ...
        public async Task<IActionResult> Create([Bind("TicketId,FlightId,PassengerId,SeatNumber,Price,Status")] Ticket ticket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TicketId,FlightId,PassengerId,SeatNumber,Price,Status")] Ticket ticket)
        {
